...
interface DialogProps {
  ...
  positiveBtnBgColor?: string | undefined;
  negativeBtnBgColor?: string | undefined;
  positiveBtnTextColor?: string | undefined;
  negativeBtnTextColor?: string | undefined;
    ...
    <Modal
      ...
      <TouchableOpacity
        ...
        <TouchableOpacity activeOpacity={1} style={styles.dialogCont}>
          <Label
            singleLine
            style={[styles.headerTitle, {backgroundColor: headerBgColor}]}
          ...
          <View style={styles.btnCont}>
            <Ripple
              style={[styles.btn, {backgroundColor: negativeBtnBgColor}]}
              rippleColor={rippleColor}
              onPress={onNegativePress}>
              <Label small align="center" color={negativeBtnTextColor}>
                {negativeBtnText}
              </Label>
            </Ripple>
            <Ripple
              style={[styles.btn, {backgroundColor: positiveBtnBgColor}]}
              rippleColor={rippleColor}
              onPress={onPositivePress}>
              <Label small align="center" color={positiveBtnTextColor}>
                {positiveBtnText}
              </Label>
            </Ripple>
          </View>
