...
const Success = {
    ...
    postShare: 'Post shared successfully',
    postAdd: 'Post added successfully',
    commentAdd: 'Comment added successfully',
    followUser: 'User followed successfully',
    shareQuestion: 'Question shared successfully',
    profilePicUpdate: 'Profile picture updated successfully',
    photosAdded: 'Photos added successfully',
    photosDeleted: 'Photo deleted successfully',
...
export default {Errors, PermissionMessage,Success};
